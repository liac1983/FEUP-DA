...
TEST(test_2_4_3, undir_from_weightedOutDegree) {
    Graph<int> gUndir;

    for (int i = 1; i <= 9; i++)
        gUndir.addVertex(i);

    gUndir.addEdge(1,2,5);
    gUndir.addEdge(2,1,5);
    gUndir.addEdge(1,3,4);
    gUndir.addEdge(3,1,4);
    gUndir.addEdge(2,4,8);
    gUndir.addEdge(4,2,8);
    gUndir.addEdge(3,4,7);
    gUndir.addEdge(4,3,7);
    gUndir.addEdge(4,5,3);
    gUndir.addEdge(5,4,3);
    gUndir.addEdge(5,6,5);
    gUndir.addEdge(6,5,5);
    gUndir.addEdge(5,7,9);
    gUndir.addEdge(7,5,9);
    gUndir.addEdge(6,9,1);
    gUndir.addEdge(9,6,1);
    gUndir.addEdge(7,8,2);
    gUndir.addEdge(8,7,2);
    gUndir.addEdge(8,9,42);
    gUndir.addEdge(9,8,42);

    EXPECT_EQ(9, FunWithGraphs::weightedOutDegree(gUndir, 1));
    EXPECT_EQ(13, FunWithGraphs::weightedOutDegree(gUndir, 2));
    EXPECT_EQ(11, FunWithGraphs::weightedOutDegree(gUndir, 3));
    EXPECT_EQ(18, FunWithGraphs::weightedOutDegree(gUndir, 4));
    EXPECT_EQ(17, FunWithGraphs::weightedOutDegree(gUndir, 5));
    EXPECT_EQ(6, FunWithGraphs::weightedOutDegree(gUndir, 6));
    EXPECT_EQ(11, FunWithGraphs::weightedOutDegree(gUndir, 7));
    EXPECT_EQ(44, FunWithGraphs::weightedOutDegree(gUndir, 8));
    EXPECT_EQ(43, FunWithGraphs::weightedOutDegree(gUndir, 9));
    EXPECT_EQ(-1, FunWithGraphs::weightedOutDegree(gUndir, 0));
    EXPECT_EQ(-1, FunWithGraphs::weightedOutDegree(gUndir, 10));
}
